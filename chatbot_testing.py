...
def input_user(chat):
    # id unique per user using unique MACaddress (uuid and getnode() function) 
    id_unique_user = ""+hex(uuid.getnode());
    ...
    if ctm.get_status_book() == "True": #Context true
        ...
        #Check threshold > 0.85
            ...
            if pred_intent == "cancel":
                ...
                #Check status email
                    ...
                    respon = "Oke😊, silahkan masukkan email kamu.";
                
                #Check status phone
                elif ctm.status_phone() == False:
                    respon = "Oke☺😊, silahkan masukkan nomor telepon kamu.";
                
                #Check status nama asrama
                elif ctm.status_dorm_name() == False:
                    respon = "Oke😊, silahkan memasukkan nama asrama yang kamu inginkan.";
                
                #Check status room number
                elif ctm.status_room_num() == False:
                    respon = "Kamar nomor berapa yang kamu inginkan?";
                
                #Check status posisi bed
                elif ctm.status_posisi_bed() == False:
                    respon = "Posisi tempat tidur mana yang kamu inginkan?";
                    ...
                    if ctm.get_dorm_name() == value_asrama and ctm.get_room_num() == value_number_room and ctm.get_posisi_bed()==value_number_bed and value_status== "avail":
                        ...
                        # if ctm.get_dorm_name == "annex":
                        respon = "Maaf, kamar yang kamu inginkan tidak tersedia sekarang ini. Klik link berikut untuk melihat kamar yang tersedia.  <br> <a href='http://localhost/elsven_evas1/available_room/annex.php' target='_blank'>Kamar yang tersedia di Asrama Annex</a> <br> <a href='http://localhost/elsven_evas1/available_room/edelweiss.php' target='_blank'>Kamar yang tersedia di Asrama Edelweiss</a> <br> <a href='http://localhost/elsven_evas1/available_room/jasmine1.php' target='_blank'>Kamar yang tersedia di Asrama Jasmine 1</a> <br> <a href='http://localhost/elsven_evas1/available_room/jasmine2.php' target='_blank'>Kamar yang tersedia di Asrama Jasmine 2</a> <br> <a href='http://localhost/elsven_evas1/available_room/bougenville.php' target='_blank'>Kamar yang tersedia di Asrama Bougenville</a> <br> <a href='http://localhost/elsven_evas1/available_room/crystal.php' target='_blank'>Kamar yang tersedia di Asrama Crystal</a> <br> <a href='http://localhost/elsven_evas1/available_room/genset.php' target='_blank'>Kamar yang tersedia di Asrama genset</a> <br> <a href='http://localhost/elsven_evas1/available_room/guesthouse.php' target='_blank'>Kamar yang tersedia di Asrama Guest House</a>"
                        
                        # if ctm.get_dorm_name == "edelweiss":
                        #     respon = "Maaf, kamar yang kamu inginkan tidak tersedia sekarang ini. Klik link berikut untuk melihat kamar yang tersedia.  <br> <a href='http://localhost/elsven_evas1/available_room/edelweiss.php' target='_blank'>Kamar yang tersedia di Asrama Edelweiss</a> "
        ...
        #if user input unrecognize predict
        else:
            ...
            if len(df_all_entities.index) > 0: #Info asrama
                ...
                if len(df_get_dm_room_model.index) > 0:
                    ...
                    if ctm.read_req_dorm_name() == "crystal 1":
                        return random.choice(my_dict["resp_room_model_crystal_1"])
                
                if len(df_get_dm_room_model.index) > 0:
                    ctm.set_req_dorm_name(df_get_dm_room_model['Value'].iloc[0])
                    if ctm.read_req_dorm_name() == "crystal 2":
                        return random.choice(my_dict["resp_room_model_crystal_2"])
                
                if len(df_get_dm_room_model.index) > 0:
                    ctm.set_req_dorm_name(df_get_dm_room_model['Value'].iloc[0])
                    if ctm.read_req_dorm_name() == "crystal 3":
                        return random.choice(my_dict["resp_room_model_crystal_3"])
                else:
        ...
        if max_sim >= threshold:
            ...
            #Scenario ask about rules asrama without adding entities
            ...
            if pred_intent == "cancel" or pred_intent == "yes":
