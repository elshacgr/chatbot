...
my_dict = {
    ...
    'resp_kapasitas'        : ['Setiap asrama memiliki kapasitas kamar yang beragam. Berikut adalah detail kapasitas kamar setiap asrama yang ada <br>https://drive.google.com/drive/u/0/folders/1zCOmk5k0cDgiNMBvzdndfxxd1635sMf1'],
    ...
    'resp_room_model_edelweiss'     : ['Untuk melihat visualisasi kamar asrama Edelweiss, kamu bisa mengunjungi link berikut: <br> <a href="https://elshacgr.github.io/jasmine-two-room" target="_blank">Visualisasi Kamar Asrama Edelweiss</a>'],
    
    'resp_room_model_annex'         : ['Untuk melihat visualisasi kamar asrama Annex, kamu bisa mengunjungi link berikut: <br> <a href="https://elshacgr.github.io/jasmine-two-room" target="_blank">Visualisasi Kamar Asrama Annex</a>'],
    
    'resp_room_model_bougenville'   : ['Untuk melihat visualisasi kamar asrama Bougenville, kamu bisa mengunjungi link berikut: <br> <a href="https://elshacgr.github.io/jasmine-two-room" target="_blank">Visualisasi Kamar Asrama Bougenville</a>'],
    
    'resp_room_model_jasmine_1'     : ['Untuk melihat visualisasi kamar asrama Jasmine 1, kamu bisa mengunjungi link berikut: <br> <a href="https://elshacgr.github.io/jasmine-two-room" target="_blank">Visualisasi Kamar Asrama Jasmine 1</a>'],
    
    'resp_room_model_jasmine_2'     : ['Untuk melihat visualisasi kamar asrama Jasmine 2, kamu bisa mengunjungi link berikut: <br> <a href="https://elshacgr.github.io/jasmine-two-room target="_blank">Visualisasi Kamar Asrama Jasmine 2</a>'],
    
    'resp_room_model_genset'        : ['Untuk melihat visualisasi kamar asrama Genset, kamu bisa mengunjungi link berikut: <br> <a href="https://elshacgr.github.io/jasmine-two-room" target="_blank">Visualisasi Kamar Asrama Genset</a>'],
    
    'resp_room_model_guest_house'   : ['Untuk melihat visualisasi kamar asrama Guest House, kamu bisa mengunjungi link berikut: <br> <a href="https://elshacgr.github.io/jasmine-two-room" target="_blank">Visualisasi Kamar Asrama Guest House</a>'],
    
    'resp_room_model_crystal_1'       : ['Untuk melihat visualisasi kamar asrama Crystal 1, kamu bisa mengunjungi link berikut: <br> <a href="https://elshacgr.github.io/jasmine-two-room" target="_blank">Visualisasi Kamar Asrama Crystal 1</a>'],
    
    'resp_room_model_crystal_2'       : ['Untuk melihat visualisasi kamar asrama Crystal 2, kamu bisa mengunjungi link berikut: <br> <a href="https://elshacgr.github.io/jasmine-two-room" target="_blank">Visualisasi Kamar Asrama Crystal 2</a>'],
    
    'resp_room_model_crystal_3'       : ['Untuk melihat visualisasi kamar asrama Crystal 3, kamu bisa mengunjungi link berikut: <br> <a href="https://elshacgr.github.io/jasmine-two-room" target="_blank">Visualisasi Kamar Asrama Crystal 3</a>'],
    
    'resp_room_model'       : ['Berikut adalah dena untuk memvisualisasikan kamar asrama yang diinginkan https://elshacgr.github.io/jasmine-two-room', 
                               'https://elshacgr.github.io/jasmine-two-room'],
    ...
    'resp_price'            : ['Setiap asrama memiliki berbagai fasilitas yang berbeda-beda sehingga harganyapun beragam. Berikut adalah detail harga setiap asrama https://www.unklab.ac.id/biaya-perkuliahan'],
    ...
    'resp_activity'         : ['Umm.. sedang merespon pesan Anda', 
                               ...
                               'Chatterbot adalah sebuah program komputer yang dirancang untuk menyimulasikan percakapan intelektual dengan satu atau lebih manusia baik secara audio maupun teks.'],
